        ...
        if(empty($_POST['simpan']))
        {
            ...
            if(!empty($result))
            {
                $data = [
                    ...
                    'penjualan_tiket'  => $result['Penjualan_Tiket'],
                    'metode_pembayaran'=> $result['Metode_Pembayaran'],
                    'akses_wifi'       => $result['Akses_Wifi'],
                    'informasi_event'  => $result['Informasi_Event'],
                    'informasi_diskon' => $result['Informasi_Diskon'],
                    'spot_foto'        => $result['Spot_Foto'],
                    'informasi'        => $result['Informasi'],
