...
<html
  lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"  data-assets-path="<?= base_url().'assets/assets/';?>"
...
>
  <head>
    ...
    <link rel="stylesheet" href="assets/boostrap/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  ...
  <body>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Smart</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Smart Method System! 👋</h4>
              <p class="mb-4">Please sign-in to your account!</p>
              <form class="mb-3" action="javascript:void(0);" id="loginForm">
                <div class="mb-3">
    ...
    <script src="assets/assets/vendor/libs/popper/popper.j"></script>
